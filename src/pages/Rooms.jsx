      ...
      <Modal open={showForm} onClose={()=>{setShowForm(false);setEditRoom(null);setForm(blank)}} title={editRoom?`Edit Room ${editRoom.room_number}`:'Add New Room'}>
        <form onSubmit={saveRoom}>
          <div className="g2">
            ...
            <div className="form-group"><label className="form-label">Floor *</label><input className="form-input" type="number" min="1" max="20" value={form.floor} onChange={e=>setForm({...form,floor:parseInt(e.target.value)})}/></div>
